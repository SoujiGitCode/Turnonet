         ...
         <tr>
            <td align="left">
               <table cellpadding="0" cellspacing="0" border="0" width="640" align="center" style="background: #ffffff!important;
                  ...
                  <tr >
                     <td style="color: #666666!important; font-size:14px!important;font-family: 'Montserrat',sans-serif!important;     padding: 0px 0px 40px 40px; height: 5px;    line-height: 25px!important;">Puede obtener más información accediendo a su cuenta: <br><br>
                        <a href="<?php echo url('/');?>" target="_blank" style="line-height: 36px!important;
