               ...
               <table cellpadding="0" cellspacing="0" border="0" width="640" align="center" style="background: #ffffff!important;
                  ...
                  <tr>
                     <td style="font-size: 18px;
                        color: #727272;
                        font-weight: 800; text-align: center!important; font-family: 'Montserrat',sans-serif!important; padding: 5px;padding-top: 40px; height: 10px;    line-height: 28px!important;border-top: 1px solid #f7f6f6;">
                        AGENDA EL TURNO EN TU CALENDARIO
                     </td>
                  </tr>
                  <tr>
                                             ...
                                             <tr>
                                                <td style="text-align: center; padding-top: 4px; padding-bottom: 4px" align="center">
                                                   <div style="font-size:12px;font-style:normal;font-weight:400">
                                                      <a href="<?php echo $btn_google;?>" target="_blank">
                                                      <img style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: 
                                                         auto;line-height: 100%;margin: 0 auto;float: none;width: auto;max-width: 100px;" 
                                                         src="<?php echo url('/')?>/uploads/icons/google.png" 
                                                         alt="" border="0" width="auto" class="center fullwidth">
                                                      </a>
                                                   </div>
                                                </td>
                                             </tr>
                                       ...
                                       <table style="border-spacing:0;border-collapse:collapse;vertical-align:top" border="0" cellspacing="0" cellpadding="0" width="100%">
                                          <tbody>
                                             <tr>
                                                <td style="text-align: center; padding-top: 4px; padding-bottom: 4px" align="center">
                                                   <div style="font-size:12px;font-style:normal;font-weight:400">
                                                      <a href="<?php echo $btn_ical ;?>" target="_blank">
                                                      <img style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: 
                                                         auto;line-height: 100%;margin: 0 auto;float: none;width: auto;max-width: 100px;" 
                                                         src="<?php echo url('/')?>/uploads/icons/ical.png" 
                                                         alt="" border="0" width="auto" class="center fullwidth">
                                                      </a>
                                                   </div>
                                                </td>
                                       ...
                                       <table style="border-spacing:0;border-collapse:collapse;vertical-align:top" border="0" cellspacing="0" cellpadding="0" width="100%">
                                          <tbody>
                                             <tr>
                                                <td style="text-align: center; padding-top: 4px; padding-bottom: 4px" align="center">
                                                   <div style="font-size:12px;font-style:normal;font-weight:400">
                                                      <a href="<?php echo $btn_outlook ;?>" target="_blank">
                                                      <img style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: 
                                                         auto;line-height: 100%;margin: 0 auto;float: none;width: auto;max-width: 100px;" 
                                                         src="<?php echo url('/')?>/uploads/icons/outlook.png" 
                                                         alt="" border="0" width="auto" class="center fullwidth">
                                                      </a>
                                                   </div>
                                                </td>
                                       ...
                                       <table style="border-spacing:0;border-collapse:collapse;vertical-align:top" border="0" cellspacing="0" cellpadding="0" width="100%">
                                          <tbody>
                                             <tr>
                                                <td style="text-align: center; padding-top: 4px; padding-bottom: 4px" align="center">
                                                   <div style="font-size:12px;font-style:normal;font-weight:400">
                                                      <a href="<?php echo $btn_yahoo ;?>" target="_blank">
                                                      <img style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: 
                                                         auto;line-height: 100%;margin: 0 auto;float: none;width: auto;max-width: 100px;" 
                                                         src="<?php echo url('/')?>/uploads/icons/yahoo.png" 
                                                         alt="" border="0" width="auto" class="center fullwidth">
                                                      </a>
                                                   </div>
                                                </td>
                  ...
                  <tr>
                     <td style="font-size: 18px;
                        color: #FF5722;
                        font-weight: 700; text-align: center!important; font-family: 'Montserrat',sans-serif!important;padding-top: 40px; padding-bottom: 20px; height: 10px;    line-height: 2px!important;border-top: 1px solid #f7f6f6;">
                        <a href="<?php echo $btn;?>" target="_blank" style="line-height: 36px!important;
                           ...
                           line-height: 36px!important;">CANCELAR TURNO</a>
                     </td>
                  </tr>
                  @endif
                  <tr>
