            ...
            <div class="col s12">
               <div class="widget z-depth-1">
                 <div class="widget-bar"> 
                  <div class="col s4">
                     <a class="btn orange" href="{{url('widget/create')}}"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo Widget </a>
                  </div>
                  <div class="col s8">
                         ...
                         <thead>
                           ...
                           <tr ng-repeat="row in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" id="item_@{{row.id}}">
                              ...
                              <span class="controls">
                                ...
                                <a href="{{url('/')}}/widget/@{{row.id}}/edit" class="edituser blue"><i class="ti-pencil-alt"></i> Editar</a>
...
app.controller('paginado', function($scope, $http, $window) {
    //Listar Paginas 
    $scope.rows = function() {
        $http.get("{{url('widgets_lists')}}").then(function successCallback(response)  {
...
$('#navsm').sortable({
    ...
    update: function() {
        ...
        $.post("{{url('move-widget')}}", order, function(theResponse) {
