                  ...
                  <div class="widget-bar">
                     <div class="col s8">
                        ...
                        <div class="md-input-16">
                           {!!Form::select('pay', ['1' => 'Paga','2'=>'No Paga'],1,['class' => 'browser-default','style'=>'background-color: #fafafa;border:1px solid rgba(0, 0, 0, .12)','id'=>'pay','onchange'=>'angular.element(this).scope().rows()'])!!}
                        </div>
                        <div class="md-input-16">
                  ...
                  <div class="widget-content" style="    flex: auto;">
                     <div class="projects-table" style="width: 100%">
                        <table width="100%" class="table">
                           <thead>
                              <tr>
                                 <th style="width: 8%;cursor: pointer" title="Ordernar" ng-click="sortBy('name')">Nombre/Correo  <span   class="sortorder" ng-show="propertyName === 'name'" ng-class="{reverse: reverse}"></span></th>
                                 <th style="width: 5%;cursor: pointer; text-align: center;" title="Ordernar" ng-click="sortBy('lenders')">Pres <span   class="sortorder" ng-show="propertyName === 'lenders'" ng-class="{reverse: reverse}"></span></th>
                                 <th style="width: 5%;cursor: pointer;text-align: center;" title="Ordernar">Paga</th>
                                 <th style="width: 5%;cursor: pointer;text-align: center;" title="Ordernar" ng-click="sortBy('ua')">MA <span   class="sortorder" ng-show="propertyName === 'ua'" ng-class="{reverse: reverse}"></span></th>
                                 <th style="width: 5%;cursor: pointer;text-align: center;" title="Ordernar" ng-click="sortBy('um')">UM <span   class="sortorder" ng-show="propertyName === 'um'" ng-class="{reverse: reverse}"></span></th>
                                 <th style="width: 5%;cursor: pointer;text-align: center;" title="Ordernar" ng-click="sortBy('sms')">SMS <span   class="sortorder" ng-show="propertyName === 'sms'" ng-class="{reverse: reverse}"></span></th>
                                 <th style="width: 5%;cursor: pointer;text-align: center;" title="Ordernar">%MP</th>
                                 <th style="width: 10%;cursor: pointer;text-align: center;" title="Ordernar" ng-click="sortBy('total_commission')">TC <span   class="sortorder" ng-show="propertyName === 'total_commission'" ng-class="{reverse: reverse}"></span></th>
                                 <th style="width: 5%;cursor: pointer;text-align: center;" title="Ordernar">Video</th>
                           ...
                           <tbody>
                              ...
                              <tr ng-repeat="row in filtered = (list | filter:search  | orderBy : propertyName :reverse) | orderBy : propertyName :reverse | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" class="results-table" style="background-color: @{{row.color}};    border-bottom: 1px dashed #a59e9e;">
                                 ...
                                 <td style="vertical-align: middle; text-align: center;"> @{{row.lenders}}</td>
                                 <td style="vertical-align: middle; text-align: center;"> @{{row.pay}} </td>
                                 <td style="vertical-align: middle;text-align: center;"> @{{row.ua}} </td>
                                 <td style="vertical-align: middle;text-align: center;"> @{{row.um}} </td>
                                 <td style="vertical-align: middle;text-align: center;">
                                    <div ng-show="row.status_smscontrol=='ALTA'">@{{row.sms}}</div>
                                    <div ng-show="row.status_smscontrol=='BAJA'">@{{row.status_smscontrol}}</div>
                                 </td>
                                 <td style="vertical-align: middle; text-align: center;">  @{{row.mp }} </td>
                                 <td style="vertical-align: middle; text-align: center;">  @{{row.total_commission }} </td>
                                 <td style="vertical-align: middle; text-align: center;">  @{{row.zoom }} </td>
                                 <td style="vertical-align: middle;">
                                    <select name="select_1" class="browser-default select-list" id="@{{row.id}}" onchange="selectOpt(this.id)" style="background-color: #fafafa;border:1px solid rgba(0, 0, 0, .12)">
                                       ...
                                       <optgroup label="PAGOS" ng-show="row.status_business=='ALTA'" >
                                          ...
                                          <option value="2"  ng-show="row.status_business=='ALTA' && row.pay=='SI'">Crear Factura</option>
                     ...
                     <div class="row results-table" ng-show="filteredItems != 0" style="border-top: 1px solid #ddd;">
                        ...
                        <div class="col s3">
                           <a  class="btn orange" target="_blank" ng-click="reports()" style="height: 45px;line-height: 50px; border-radius: 0.3rem;background-color: #33b56a!important;"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargá  Excel</a>
                        </div>
                        <div class="input-field col s12">
...
<script type="text/javascript">
   ...
   $scope.reports= function() {
      ...
      var url="{{url('/')}}/excel/business/" + pay+"/" + status;
