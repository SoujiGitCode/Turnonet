      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            <div class="panel-heading">
               Configure las notificaciones de tu prestador aquí:
            </div>
            <div class="panel-body">
               <form id="form">
                  <input type="hidden" name="id" value="<?php echo $get_lender->tmsp_id;?>">
                    <div class="form-group" style="clear: both;">
                     <p>Esta notificación debería ser distinta a la de la empresa y sucursal, dando algun detalle especifico del prestador.</p>
                     <br>
                  ...
                  <div class="form-group">
                     <div class="demoo1">
                        <input type="checkbox" name="pc_suc_msg" id="pc_suc_msg" value="1" @if($settings->pc_suc_msg=='1') checked="checked" @endif>
                        <label for="pc_suc_msg"><span></span>Incluir mensaje de la sucursal</label>
                     </div>
                  </div>
                  <div class="form-group">
                     <div class="demoo1">
