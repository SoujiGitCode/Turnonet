...
<div class="container">
   <div class="row">
      <div class="col-xs-12">
         ...
         <h4 class="title-date-2">Configuración de la sucursal</h4>
      </div>
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            <div class="panel-heading">
               Actualice las configuración de tu sucursal aquí:
            </div>
            <div class="panel-body">
               <form id="form">
                  ...
                  <p>Seleccione los parámetros generales de configuración de la sucursal. Estos parámetros serán utilizados en caso que no defina parametros por para el prestador. En caso de duda o consulta comuniquese con nuestro sector de soporte.</p>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="demoo1">
                              ...
                              <label for="cf_daysp_all"><span></span>Aplicar prestadores de la sucursal.</label>
                           </div>
                        </div>
                     </div>  
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="demoo1">
                              ...
                              <label for="cf_days_all"><span></span>Aplicar a todos los prestadores de la sucursal.</label>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="demoo1">
                              ...
                              <label for="cf_tcan_all"><span></span>Aplicar a todos los prestadores de la sucursal.</label>
                           </div>
                        </div>
                     </div>
                  </div> 
