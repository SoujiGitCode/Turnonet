...
<div class="container">
   <div class="row">
      <div class="col-xs-12">
         ...
         <h4 class="title-date-2">Genear Reportes</h4>
      </div>
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            ...
            <div class="panel-body">
               <form id="form">
                <input type="hidden" name="name" id="name" value="<?php echo mb_convert_encoding($get_branch->suc_nom, 'UTF-8', 'UTF-8');?>">
                <input type="hidden" name="suc_id" id="suc_id" value="<?php echo $get_branch->suc_id;?>">
