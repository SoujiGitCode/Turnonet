               ...
               <div class="panel-body">
                  ...
                  <div class="form-group text-center">
                     ...
                     <div class="form-group ">
                       <input type="file" id="attachment-2" name="suc_pfot" class="inputfile inputfile-1">
                        <label for="attachment-2" id="iborrainputfile" accept="image/x-png,image/gif,image/jpeg">
							<i class="fa fa-picture-o" aria-hidden="true">
							</i> SELECCIONAR IMAGEN</label>
                     </div>
