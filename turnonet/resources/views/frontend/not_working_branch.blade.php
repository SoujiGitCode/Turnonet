      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            ...
            <div class="panel-body">
               <form id="form">
                  <p>Seleccioná el feriado que desea establecer como no laborable a sus agendas. Esto se aplicara a todos los prestadores de la sucursal.</p>
                  <div class="row">
                           ...
                           <table width="100%" class="table" id="sample-table-1" >
                               <thead>
                                 <tr>
                                    ...
                                    <th style="width: 20%; text-align: center;">Cant Prestadores</th>
...
<?php echo Html::script('frontend/js/not_working_branch.js?v='.time())?>
@stop