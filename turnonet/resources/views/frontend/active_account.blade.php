...
<div class="container p-4">
   <div class="row">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 mx-auto">
         ...
         <p style="text-align: center;color: #fff"> <span >Turnonet </span> © 2012 - {{date("Y")}} Todos los derechos reservados.</p>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-12"></div>
   </div>
</div>
<script type="text/javascript">
   history.pushState({foo: "/" }, "Iniciar Sesion", "/");
