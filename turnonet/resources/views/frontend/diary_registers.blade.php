   ...
   <div class="row">
      <div class="col-md-8 col-sm-8 col-xs-12">
         ...
         <ul class="nav nav-pills">
            ...
            <li class="active"><a href="<?php echo url('agenda/empresa/diarios/'.$get_business->em_id);?>">Registros Diarios</a></li>
...
<?php echo Html::script('frontend/js/diary_register.js?v='.time())?>
