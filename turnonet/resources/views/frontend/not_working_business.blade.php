      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            ...
            <div class="panel-body">
               <form id="form">
                  <p>Seleccioná el feriado que desea establecer como no laborable a sus agendas. Esto se aplicara a todos los prestadores de la empresa.</p>
                  <div class="row">
...
<?php echo Html::script('frontend/js/not_working.js?v='.time())?>
@stop