...
<div class="container">
   <div class="row">
      <div class="col-xs-12">
         ...
         <h4 class="title-date-2">Configuración de la empresa</h4>
      </div>
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            <div class="panel-heading">
               Actualice las configuración de tu empresa aquí:
            </div>
            <div class="panel-body">
               <form id="form">
                  ...
                  <p>Seleccione los parámetros generales de configuración de la empresa. Estos parámetros serán utilizados en caso que no defina parametros por sucursal o prestador. En caso de duda o consulta comuniquese con nuestro sector de soporte.</p>
                  ...
                  <div class="form-group btop bdashed">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="demoo1">
                              <input type="checkbox" name="cf_daysp_all" id="cf_daysp_all" value="1" @if($settings->cf_daysp_all=='1') checked="checked" @endif>
                              <label for="cf_daysp_all"><span></span>Aplicar a todas las sucursales y prestadores de la empresa.</label>
                           </div>
                        </div>
                     </div>  
                  </div>
                  <div class="form-group btop bdashed">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="demoo1">
                              <input type="checkbox" name="cf_days_all" id="cf_days_all" value="1" @if($settings->cf_days_all=='1') checked="checked" @endif>
                              <label for="cf_days_all"><span></span>Aplicar a todas las sucursales y prestadores de la empresa.</label>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="form-group btop bdashed">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="demoo1">
                              <input type="checkbox" name="cf_tcan_all" id="cf_tcan_all" value="1" @if($settings->cf_tcan_all=='1') checked="checked" @endif>
                              <label for="cf_tcan_all"><span></span>Aplicar a todas las sucursales y prestadores de la empresa.</label>
                           </div>
                        </div>
                     </div>
                  </div> 
                  <div class="form-group btop bdashed">
                     <label class="label-1">Agendas en Frame:</label>
                     <p class="form-desc">Defina la cantidad de agendas a mostrar en el frame.</p>
                     <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                           <label>Cantidad</label>
                           <select name="em_presxag" class="form-control" id="em_presxag">
                              <option value="">Seleccione</option>
                              <option value="5" @if($get_business->em_presxag=="5") selected="selected" @endif >5 Agendas</option>
                              <option value="6" @if($get_business->em_presxag=="6") selected="selected" @endif >6 Agendas</option>
                              <option value="7" @if($get_business->em_presxag=="7") selected="selected" @endif >7 Agendas</option>
                              <option value="8" @if($get_business->em_presxag=="8") selected="selected" @endif >8 Agendas</option>
                              <option value="9" @if($get_business->em_presxag=="9") selected="selected" @endif>9 Agendas</option>
                              <option value="10" @if($get_business->em_presxag=="10") selected="selected" @endif>10 Agendas</option>
                              <option value="15" @if($get_business->em_presxag=="15") selected="selected" @endif>15 Agendas</option>
                              <option value="20" @if($get_business->em_presxag=="20") selected="selected" @endif>20 Agendas</option>
                              <option value="20" @if($get_business->em_presxag=="25") selected="selected" @endif>25 Agendas</option>
                              <option value="20" @if($get_business->em_presxag=="30") selected="selected" @endif>30 Agendas</option>
                           </select>
                        </div>
                     </div>
                  </div> 
                  <div class="form-group btop bdashed">
                   ...
                   <div class="form-group btop bdashed">
                     <label class="label-1">Turnos Por Usuario:</label>
                     <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                           <label>Cantidad</label>
                           <select name="shift_user" class="form-control" id="shift_user">
                              <option value="0" @if($get_business->shift_user=="0") selected="selected" @endif>Sin límite</option>
                              <option value="1" @if($get_business->shift_user=="1") selected="selected" @endif>1 Turno por día</option>
                              <option value="2"  @if($get_business->shift_user=="2") selected="selected" @endif>2 Turnos por día</option>
                              <option value="3"  @if($get_business->shift_user=="3") selected="selected" @endif>3 Turnos por día</option>
                              <option value="4"  @if($get_business->shift_user=="4") selected="selected" @endif>4 Turnos por día</option>
                              <option value="5"  @if($get_business->shift_user=="5") selected="selected" @endif>5 Turnos por día</option>
                              <option value="6" @if($get_business->shift_user=="6") selected="selected" @endif>1 Turno por semana</option>
                              <option value="7"  @if($get_business->shift_user=="7") selected="selected" @endif>2 Turnos por semana</option>
                              <option value="8"  @if($get_business->shift_user=="8") selected="selected" @endif>3 Turnos por semana</option>
                              <option value="9"  @if($get_business->shift_user=="9") selected="selected" @endif>4 Turnos por semana</option>
                              <option value="10"  @if($get_business->shift_user=="10") selected="selected" @endif>5 Turnos por semana</option>
                              <option value="11" @if($get_business->shift_user=="11") selected="selected" @endif>1 Turno por mes</option>
                              <option value="12"  @if($get_business->shift_user=="12") selected="selected" @endif>2 Turnos por mes</option>
                              <option value="13"  @if($get_business->shift_user=="13") selected="selected" @endif>3 Turnos por mes</option>
                              <option value="14"  @if($get_business->shift_user=="14") selected="selected" @endif>4 Turnos por mes</option>
                              <option value="15"  @if($get_business->shift_user=="15") selected="selected" @endif>5 Turnos por mes</option>
                           </select>
                        </div>
                     </div>
                     <p class="form-desc"><br>Define la cantidad de turnos que puede tomar un usuario.</p>
                  </div>
                  <div class="form-group btop bdashed">
                     <label class="label-1">Turnos Por IP:</label>
                     <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                           <label>Cantidad</label>
                           <select name="ip_user" class="form-control" id="ip_user">
                              <option value="0" @if($get_business->ip_user=="0") selected="selected" @endif>Sin límite</option>
                              <option value="1" @if($get_business->ip_user=="1") selected="selected" @endif>1 Turno por día</option>
                              <option value="2"  @if($get_business->ip_user=="2") selected="selected" @endif>2 Turnos por día</option>
                              <option value="3"  @if($get_business->ip_user=="3") selected="selected" @endif>3 Turnos por día</option>
                              <option value="4"  @if($get_business->ip_user=="4") selected="selected" @endif>4 Turnos por día</option>
                              <option value="5"  @if($get_business->ip_user=="5") selected="selected" @endif>5 Turnos por día</option>
                              <option value="6" @if($get_business->ip_user=="6") selected="selected" @endif>1 Turno por semana</option>
                              <option value="7"  @if($get_business->ip_user=="7") selected="selected" @endif>2 Turnos por semana</option>
                              <option value="8"  @if($get_business->ip_user=="8") selected="selected" @endif>3 Turnos por semana</option>
                              <option value="9"  @if($get_business->ip_user=="9") selected="selected" @endif>4 Turnos por semana</option>
                              <option value="10"  @if($get_business->ip_user=="10") selected="selected" @endif>5 Turnos por semana</option>
                              <option value="11" @if($get_business->ip_user=="11") selected="selected" @endif>1 Turno por mes</option>
                              <option value="12"  @if($get_business->ip_user=="12") selected="selected" @endif>2 Turnos por mes</option>
                              <option value="13"  @if($get_business->ip_user=="13") selected="selected" @endif>3 Turnos por mes</option>
                              <option value="14"  @if($get_business->ip_user=="14") selected="selected" @endif>4 Turnos por mes</option>
                              <option value="15"  @if($get_business->ip_user=="15") selected="selected" @endif>5 Turnos por mes</option>
                           </select>
                        </div>
                     </div>
                     <p class="form-desc"><br>Define la cantidad de turnos que puede tomar un usuario con una misma dirección IP.</p>
                  </div>
                  <div class="form-group btop bdashed">
                     <label class="label-1">Recordatorios:</label>
                     <p class="form-desc">Defina la configuración de los recordatorios por correo electrónico. </p>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="demoo1">
                              <input type="checkbox" name="reminder_1" id="reminder_1" value="1" @if($get_business->reminder_1=='1') checked="checked" @endif>
                              <label for="reminder_1"><span></span>Activar/Desactivar el recordatorio un día antes del turno.</label>
                           </div>
                           <div class="demoo1">
                              <input type="checkbox" name="reminder_5" id="reminder_5" value="1" @if($get_business->reminder_5=='1') checked="checked" @endif>
                              <label for="reminder_5"><span></span>Activar/Desactivar el recordatorio cinco días antes del turno.</label>
                           </div>
                        </div>
                     </div>  
                  </div>                
