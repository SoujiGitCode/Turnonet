...
<div class="container">
   <div class="row">
      <div class="col-xs-12">
         ...
         <h4 class="title-date-2">Eliminar Prestador</h4>
      </div>
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
         <div class="panel">
            <div class="panel-heading">
               Da de baja a tu prestador aquí:
            </div>
            <div class="panel-body">
               <form id="form">
                  <input type="hidden" id="id" name="id" value="<?php echo $get_lender->tmsp_id;?>">
                   <p>Recuerda que si eliminas este prestador, perderás las sucursales, turnos y prestadores registrados en ésta. En caso de duda o consulta comuniquese con nuestro sector de soporte.</p>
                  @if($shift!=0)
                  ...
                  <div class="form-group">
                     <div class="demoo1">
                        ...
                        <label for="turnos"><span></span>Cancelar los próximos turnos del prestador.</label>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     <br>
                     <button type="button" onclick="baja_lender()" class="btn btn-success" id="boton-1">DAR DE BAJA</button>
                  </div>
               </form>
            </div>
         </div>
