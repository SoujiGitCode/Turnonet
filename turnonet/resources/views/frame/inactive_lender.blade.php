   ...
   <div class="row top-11">
         <div class="col-md-12">
            <div class="alert alert-danger" role="alert">
               El prestador ha sido  dada de baja. Para más información póngase en contacto con <?php echo ucwords(mb_convert_encoding($get_business->em_nomfan, 'UTF-8', 'UTF-8'));?>.
            </div>
         </div>
      </div>
</div>
