...
@if($frame->header==0)
<a href="<?php echo url('/');?>/e/esn/<?php echo $lender->emp_id;?>/<?php echo $lender->suc_id;?>/<?php echo $lender->tmsp_id;?>/<?php echo substr($get_business->em_valcod,0,4);?>" class="btn-back"></a>
@endif
      ...
      <div class="row">
         ...
         <div class=" col-md-4 col-sm-4 hidden-xs text-rigth">
            <div class="volver2">
               ...
               <a href="<?php echo url('/');?>/e/esn/<?php echo $lender->emp_id;?>/<?php echo $lender->suc_id;?>/<?php echo $lender->tmsp_id;?>/<?php echo substr($get_business->em_valcod,0,4);?>">Solicitar Turno</a>
            </div>
         </div>
      </div>
      <div class="row top-11">
         <div class="col-md-12">
            <div class="alert alert-danger" role="alert">
              El turno para el día y hora solicitado ya fue ocupado. Vuelva a verificar disponibilidad, disculpe las molestias.
            </div>
         </div>
      </div>
   </div>
