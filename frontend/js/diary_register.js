...
app.controller('post', function($scope, $http, $window) {
    ...
    $scope.rows = function() {
        ...
        $(".bg-preload").show();
        $(".bg-list").hide();
        $http.get($("#url").val() + '/lists_diary_register/' + $("#date").val() + '/' + $("#status").val() + '/' + $("#type_shift").val() + '/' + $("#lenders").val() + '/' + $("#branch").val() + '/' + $("#business").val()).then(function successCallback(response) {
    ...
    $scope.buscar_fecha = function() {
        ...
        if ($('#fecha_final').val() == "") {
            ...
            var url = $("#url").val() + "/excel/turnos/diarios/" + fecha_inicial + "/" + fecha_final + "/" + $("#status").val() + '/' + $("#type_shift-1").val() + '/' + $("#lenders-1").val() + '/' + $("#branch-1").val() + '/' + $("#business").val();
            window.open(url);
        }
    }
    ...
    $scope.buscar_fecha_business = function() {
        ...
        if ($('#fecha_final').val() == "") {
            ...
            if ($("#business-1").val() == "") {
                var url = $("#url").val() + "/excel/turnos/sodimac/diarios/" + fecha_inicial + "/" + fecha_final + "/" + $("#status").val() + '/' + $("#type_shift-1").val();
            } else {
                var url = $("#url").val() + "/excel/turnos/diarios/" + fecha_inicial + "/" + fecha_final + "/" + $("#status").val() + '/' + $("#type_shift-1").val() + '/' + $("#lenders-1").val() + '/' + $("#branch-1").val() + '/' + $("#business-1").val();
            }
...
function openModalAgenda() {
    $("#myModalA").modal({backdrop: 'static', keyboard: false},'show');
