var URL_WEB = 'https://v3.turnonet.com/';
var sobreturno=0;
...
function loadMap(){
 $('#firstnaveg').addClass('byenaveg');
    $("#capa").load(URL_WEB + "/e/app/cal/" + $("#empid").val() + "/" + $("#sucid").val() + "/" + $("#presid").val() + "/" + $("#month").val() + "/" + $("#year").val() + "/" + $("#vadcod").val()+"/0");
}

function setMonth(id) {
    $("#capa").load(URL_WEB + "/e/app/cal/" + $("#empid").val() + "/" + $("#sucid").val() + "/" + $("#presid").val() + "/" + $("#" + id).data("month") + "/" + $("#vadcod").val()+"/0");
}
